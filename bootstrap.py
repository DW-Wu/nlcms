...
if args.name == "ring":
    ...
    solver.solve(method='gd', metric="h1", maxiter=5000, eta=1e-4, tol=1e-8,
...
if args.name == "score":
    ...
    # solver.solve(method='gf', metric="l2", maxiter=300, eta=1e-4, tol=1e-6,
    #              maxsubiter=50, subtol=0.01, verbose=True)
